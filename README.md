...
#### 👉 [서비스 바로가기](https://moamoa-xi.vercel.app)
...
- **간편 공유** — 펀딩 생성 완료 화면과 상세 페이지에서 기기 기본 공유 시트(Web Share API)로 링크 공유 (iOS·Android·PC). 결제 완료 후에는 참여자가 주최자에게 카카오 공유 SDK로 참여 결과를 알림
